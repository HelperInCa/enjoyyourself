...
public class GeoRecommendation {
	public List<Item> recommendItems(String userId, double lat, double lon) {
		...
		Map<String, Integer> allCategories = new HashMap<>();//String: item; Integer: count
		//存储
		...
		// Step 3, do search based on category, filter out favorited and visited events, 
		//sort by distance
